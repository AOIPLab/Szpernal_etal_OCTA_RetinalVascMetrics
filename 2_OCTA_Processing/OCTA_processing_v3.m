...
cropped_thresholded = logical(cropped_thresholded.*(~BWW));
...
maskedskelimg = bwmorph(origvascAnalyzed,'skel',Inf); %old 1 pix mask
...
outfilename_croppedthresh = strrep(filename{i}, '.tif', '_CroppedThresholded.tif'); %Input for vesslloss and PICA
