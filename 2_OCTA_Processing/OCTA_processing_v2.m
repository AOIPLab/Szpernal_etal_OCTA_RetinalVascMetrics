...
title('Remove Unwanted Pixels - Drag and circle unwanted pixels. Esc to repeat this step. To quit, double click FAZ');
...
outfilename_croppedthresh = strrep(filename{i}, '.tif', '_CroppedThresholded.tif');
