...
for kk = 1:length(root_dir)
    ...
    for kkk = 1:size(Current_subfolder,1)
        ...
        newname = strcat(Currentloss_pathparts{11},'_',Currentloss_pathparts{12},'pct_Raw_Data.csv'); %Need to change {#} based on folder structure (Mac / PC) 4, 5 for PC and 11, 12 for Mac
